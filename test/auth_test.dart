//import 'package:flutter_test/flutter_test.dart' as g;
...
group('Mock Authentication', () {
  ...
  test('test should be initialized in less than 2 second',
          () async {
    await provider.initialize();
  ...
  test('LoggedIn user should be able to be verified', () async{
